...
<div class="bg-white py-16 sm:py-24" 
    ...
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        {{-- ========================================================== --}}
        {{-- === BAGIAN JUDUL BARU DENGAN LATAR KARTU === --}}
        {{-- ========================================================== --}}
        <div class="bg-gray-100 border border-gray-200 rounded-xl mx-auto max-w-4xl text-center py-12 sm:py-16 px-6 mb-16">
            <p class="text-gray-500 text-sm mb-4">
                {{ \Carbon\Carbon::parse($album->date)->translatedFormat('d F Y') }}
            </p>
            <h1 class="text-4xl font-bold tracking-tight text-gray-900 sm:text-5xl lg:text-6xl">{{ $album->title }}</h1>
            <div class="mt-6 flex items-center justify-center gap-x-4">
                <span class="inline-flex items-center rounded-md bg-teal-50 px-3 py-1 text-sm font-medium text-teal-700 ring-1 ring-inset ring-teal-600/20">
                    {{ $album->kategori ?? 'KEGIATAN KKN' }}
                </span>
            </div>
        </div>
        {{-- ========================================================== --}}
    ...
    {{-- Bagian Lightbox AlpineJS Anda (Tidak diubah, sudah bagus) --}}
